...
public class ExampleEventHandler
{
    ...
    public static boolean place(EntityPlayer player, World world)
    {
        ...
        if(heldBlock == ExampleMod.blockSidedExample)
            part = ExampleSidedPart.placement(world, pos, hit.sideHit);
        ...
        {
            player.swingItem();
            new PacketCustom(ExampleServerHandler.channel, 1).sendToServer();
        }
        return true;
    }
